            ...
            {step === "terms" && (
              ...
              >
                ...
                <div className="mt-6 h-72 overflow-y-auto border border-line rounded-xl bg-bg p-5 text-[0.78rem] text-cream-dim leading-relaxed space-y-4 font-mono scrollbar-thin">
                  ...
                  <p>10.5 <strong>Comffee-Initiated Cancellation.</strong> If Comffee cancels a reservation for reasons other than Guest violation of these Terms (e.g., force majeure events such as natural disasters, government-mandated closures, or utility failures beyond Comffee's control), a full refund of all amounts paid will be issued within 5–10 business days.</p>
