            ...
            {step === "terms" && (
              ...
              >
                ...
                <div className="mt-6 h-72 overflow-y-auto border border-line rounded-xl bg-bg p-5 text-[0.78rem] text-cream-dim leading-relaxed space-y-4 font-mono scrollbar-thin">
                  ...
                  <p>10.1 <strong>24-Hour Grace Period.</strong> Guests may cancel within 24 hours of booking confirmation for a full refund of all amounts paid, including the security deposit. Cancellation requests must be submitted in writing via email to comffee@gmail.com within 24 hours of receiving the booking confirmation.</p>
                  <p>10.2 <strong>After the 24-Hour Grace Period — Full Payment Option.</strong> All payments are strictly non-refundable. No refund will be issued for cancellations, reschedules, no-shows, or early checkouts made after the 24-hour grace period, regardless of reason.</p>
                  <p>10.3 <strong>After the 24-Hour Grace Period — 30% Reservation Fee Option.</strong> The 30% reservation fee is strictly non-refundable after the 24-hour grace period. The security deposit of ₱1,000 is likewise non-refundable upon cancellation after the grace period. The 70% balance payment is due no later than 3 days before the check-in date. Failure to remit the balance by the due date constitutes automatic cancellation of the reservation, and the 30% reservation fee and security deposit are forfeited.</p>
                  <p>10.4 <strong>Security Deposit Refund.</strong> The ₱1,000 security deposit is refundable only upon satisfactory checkout inspection with no violations, damages, missing items, or complaints, regardless of whether the stay was completed. The deposit is processed within 24–48 hours after checkout via the original payment method.</p>
                  <p>10.5 <strong>Comffee-Initiated Cancellation.</strong> If Comffee cancels a reservation for reasons other than Guest violation of these Terms (e.g., force majeure events such as natural disasters, government-mandated closures, or utility failures beyond Comffee's control), a full refund of all amounts paid will be initiated automatically via the original payment method. Refunds typically settle within 5–10 business days depending on the payment provider. Comffee is not responsible for delays caused by the Guest's bank or e-wallet provider after the refund has been issued.</p>
